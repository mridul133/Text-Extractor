...
train_file = open('digit_training_dataset_sample.txt','w')
test_file = open('digit_testing_dataset_sample.txt','w')
...
(X_train,y_train),(X_test,y_test),nb_classes = load_data("E:\Api Codes\EMNIST dataset\matlab\emnist-digits")
...
#    print(i,X_train[i].shape,chr(ord('A') + y_train[i][0] - 1))
    ...
    train_file.write(str(y_train[i][0]) + '\n')
...
#    print(i,X_test[i].shape,chr(ord('A') + y_test[i][0] - 1))
    ...
    test_file.write(str(y_test[i][0]) + '\n')
